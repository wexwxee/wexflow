...
# Показывать ли витрину подписки и карточку аккаунта пользователям.
# Пока False: в публичном релизе разделы «Подписка»/«Аккаунт» скрыты (ещё не
# готовы к показу). Включим, когда решим выводить тарифы людям.
SHOW_BILLING = False
