...
".venv\Scripts\python.exe" -m PyInstaller --onefile --windowed --noconfirm --name WexFlow-Setup --icon app.ico --distpath dist --workpath build_installer installer\installer.py
